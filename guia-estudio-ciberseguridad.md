...
1. Antivirus actualizado: Instalar y mantener siempre actualizado un software antivirus fiable es esencial para detectar y neutralizar la mayoría de los tipos de malware.
...
* ¿Qué fue? WannaCry era un ransomware que cifraba los archivos de los ordenadores infectados y exigía un pago en Bitcoin para su liberación.
* ¿Cómo se propagó? Explotó una vulnerabilidad crítica en sistemas operativos Windows que no habían sido actualizados con el parche de seguridad correspondiente. Su capacidad de propagarse como un gusano por las redes locales le permitió infectar masivamente a organizaciones enteras.
* ¿A quién afectó? El ataque tuvo un impacto devastador en servicios públicos, incluyendo hospitales del sistema de salud británico (NHS), fábricas y grandes corporaciones.
* ¿Cómo se detuvo? Su propagación inicial fue frenada gracias a que un investigador de seguridad descubrió y activó un "interruptor de emergencia" (kill switch) que los propios atacantes habían incluido en el código del malware.

La lección clave de WannaCry es doble: subraya la importancia crítica de mantener los sistemas operativos y el software siempre actualizados para protegerse de vulnerabilidades conocidas y demuestra que realizar copias de seguridad periódicas es la única garantía para recuperar la información frente a un ataque de ransomware.
...
* El Reglamento General de Protección de Datos (RGPD), que establece un marco unificado para la protección de datos en toda la Unión Europea.
* La Ley Orgánica de Protección de Datos Personales y garantía de los derechos digitales (LOPDGDD), que adapta y complementa el RGPD en el ordenamiento jurídico español.

Estas leyes se basan en una serie de principios fundamentales que rigen el tratamiento de datos:
...
A su vez, estos principios otorgan a los ciudadanos una serie de derechos digitales específicos sobre su identidad y su información:
